...
export class Ng2UiAuthModule {
  static forRoot(
    configOptions?: IPartialConfigOptions,
    ...
    return {
      ...
      providers: [
        ...
        },
        {
          ...
          deps: [HttpClient, SharedService, ConfigService]
        },
        {
        ...
        },
        {
          ...
          deps: [HttpClient, SharedService, ConfigService, PopupService]
        },
        {
          provide: AuthService,
          useClass: AuthService,
          deps: [SharedService, LocalService, OauthService]
        },
