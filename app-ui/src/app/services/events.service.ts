...
export class EventsService {
  ...
  getGiftComments(eventid: number, giftid: number): Promise<Object> {
    return this.http
      .get('/api/events/' + eventid + '/gifts/' + giftid + '/comments')
      .toPromise()
      .then(response => {
        return response;
      })
  ...
  addGiftComments(
    ...
    return this.http
      .post('/api/events/' + eventid + '/gifts/' + giftid + '/comments', {
        comment: comment
      })
      .toPromise()
      .then(response => {
  ...
  updateGiftStatus(id: number, newStatus: string): Promise<Object> {
    return this.http
      .post('/api/gifts/' + id + '/status', { status: newStatus })
      .toPromise()
      .then(response => {
        return response;
      })
  ...
  addParticipant(eventid: number, data: any): Promise<Object> {
    return this.http
      .post('/api/events/' + eventid + '/participants', data)
      .toPromise()
      .then(response => {
        return response;
      })
  ...
  editGift(eventid: number, payload: any): Promise<Object> {
    return this.http
      .post('/api/events/' + eventid + '/gifts', payload)
      .toPromise()
      .then(response => {
        return response;
      })
